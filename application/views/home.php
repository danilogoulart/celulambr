<?php
	$logado = $this->session->userdata("logado");
			...
			if (!$logado) 
				redirect(base_url('login/entrar'));
 ?>

<!DOCTYPE HTML>
<html>
<head>
<title>Projeto Pescadores de Homens - MBR</title>
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						<li class="active"><a href="<?=base_url()?>/home"><i class="lnr lnr-power-switch"></i><span>Dashboard</span></a></li>
						<li class="menu-list">
						...
						<ul>
							<li class="dropdown profile_details_drop">
								<a  href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">	
										<span style="background:url(<?=base_url()?>/assets/images/1.jpg) no-repeat center"> </span> 
										 <div col-md-8 class="user-name">
											<p><?=$this->session->userdata('nome')?><span><?=$this->session->userdata('role')?></span></p>
										 </div>
								...
								<ul class="dropdown-menu drp-mnu">
									...
									<li> <a href="<?=base_url()?>login/sair"><i class="fa fa-sign-out"></i> Logout</a> </li>
								</ul>
							</li>
							<div class="clearfix"> </div>
						</ul>
		...
		<div class="switches">
			<div class="col-4">
				...
				<div class="col-md-4 switch-right">
					...
					<div class="sparkline">
						<!--graph-->
						<link rel="stylesheet" href="<?=base_url()?>/assets/css/graph.css">
				...
				<div class="activity_box activity_box1">
					...
					<div class="scrollbar" id="style-2">
						<div class="activity-row activity-row1">
							<div class="col-xs-3 activity-img"><img src='<?=base_url()?>/assets/images/1.png' class="img-responsive" alt=""/><span>10:00 PM</span></div>
						...
						<div class="activity-row activity-row1">
							...
							<div class="col-xs-3 activity-img"><img src='<?=base_url()?>/assets/images/3.png' class="img-responsive" alt=""/><span>10:02 PM</span></div>
							<div class="clearfix"> </div>
						</div>
						<div class="activity-row activity-row1">
							<div class="col-xs-3 activity-img"><img src='<?=base_url()?>/assets/images/1.png' class="img-responsive" alt=""/><span>10:00 PM</span></div>
