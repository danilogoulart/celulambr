<?php
    ...
    $classe_nav = array();        
    for ($i=0; $i <= 8; $i++) { 
        if($nav_active == $i) {$classe_nav[$i] = $class;}
        else{$classe_nav[$i]="a";}
    }
            ...
            <div class="left-side-inner">
                ...
                <!--sidebar nav start-->
                    <ul class="nav nav-pills nav-stacked custom-nav">
                        ...
                        <li class="menu-list <?=$classe_nav[5]?>"><a href="#"><i class="lnr lnr-indent-increase"></i> <span>Menu Levels</span></a>  
                            <ul class="sub-menu-list">
                            ...
                            <li class="dropdown profile_details_drop">
                                <a  href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <div class="profile_img">   
                                        <span style="background:url(aa<?=base_url()?>/assets/images/1.jpg) no-repeat center"> </span> 
